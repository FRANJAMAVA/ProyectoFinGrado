...
<body>
	...
	<!--<button  onclick="window.location='../index/indexlogin.php'" >Login</button>-->
	...
	<button class="btn btn-primary" onclick="window.location='../index/indexmostrar.php'" >Mostrar</button>-->
	<button class="btn btn-primary" onclick="window.location='../index/indexmostrararticulos.php'" >Articulos</button>
	
	
	
	<button class="btn btn-primary" onclick="window.location='../index/indexbuscar.php'" >Ventas</button>

	<button class="btn btn-primary" onclick="window.location='../index/indexmostrarclientes.php'" >Clientes</button>
