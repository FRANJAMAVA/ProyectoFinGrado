				...
				if($datos->num_rows){
					...
					while($fila = $datos->fetch_assoc()){
						if($fila['alias']==$alias && $fila['password']==$contraseña){
							...
							if($fila['alias'] =="administrador" && $contraseña == '1718c24b10aeb8099e3fc44960ab6949ab76a267352459f203ea1036bec382c2'){
							...
							echo "<script type= 'text/javascript'> alert('Ha entrado el usuario " .$alias."con id ".$_SESSION['usuario_id']. "');
