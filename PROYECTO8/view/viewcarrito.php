	...
	<div id ="container" style="color: red;">
		...
		<a href="../index.php"><button>Inicio</button></a>
		    ...
		    <?php
				...
				foreach ($_SESSION['productos_carrito'] as  $fuente) :?>
					  ...
					  <tr>
					    <td colspan="2"><button class="btn btn-primary" onclick="window.location='../index/indexbaja.php'" >Anular</button></td>
				...
				?>
				    ...
				    <button class="btn btn-primary" onclick="window.location='../index/indexbaja.php'" >Anular compra</button>
				    <br>
				    <br>
				    <br>
				    <br>
